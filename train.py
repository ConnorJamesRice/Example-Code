...
def train(
    ...
    for i in range(epochs):
        ...
        return_dict["train"].append(np.mean(train_running_loss))
        ...
        if val_loader:
            ...
            return_dict["val"].append(np.mean(val_running_loss))
...
def plot_model_guesses(
    ...
    with torch.no_grad():
        ...
        plt.ylabel("x1")
        plt.legend()
        plt.savefig(f'question5{title}.pdf')
        plt.show()
